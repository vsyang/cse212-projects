...
public static class SetsAndMaps
{
    ...
    public static string[] FindPairs(string[] words)
    {
        ...
        List<string> symmtricalPair = new List<string>();

        foreach (var word in words)
        {
            string symmetrical = new string(word.Reverse().ToArray());

            if (set.Contains(symmetrical))
            {
                symmtricalPair.Add($"{word} & {symmetrical}");
            }
            else
            {
                set.Add(word);
    ...
    public static string[] EarthquakeDailySummary()
    {
        ...
        foreach (var feature in featureCollection.Features)
        {
            ...
            {
                summaries.Add($"Location: {place}, - Mag : {magnitude:F1}");
            }
        }
